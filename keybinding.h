...
#define FOREACH_KEYBINDING(KEYBINDING)                                                                               \
	...
	KEYBINDING(KEYBINDING_MOVE_TO_TILE,                                                                              \
	           movetoworkspace) /* data.us is the desired tile and whether or not to follow the focus */             \
	KEYBINDING(KEYBINDING_MOVE_TO_WORKSPACE,                                                                         \
	           movetoworkspace) /* data.us is the desired workspace and whether or not to follow the focus */        \
	KEYBINDING(KEYBINDING_MOVE_TO_OUTPUT,                                                                            \
	           movetoscreen) /* data.us is the desired output and whether or not to follow the focus*/               \
	KEYBINDING(KEYBINDING_MOVE_VIEW_TO_TILE,                                                                         \
	           movetoworkspace) /* data.us contains the view_id and tile_id and whether or not to follow the focus */\
	KEYBINDING(KEYBINDING_MOVE_VIEW_TO_WORKSPACE,                                                                    \
	           movetoworkspace) /* data.us contains the view_id, workspace and whether or not to follow the focus */ \
	KEYBINDING(KEYBINDING_MOVE_VIEW_TO_OUTPUT,                                                                       \
	           movetoscreen) /* data.u is the view_id, output and whether or not to follow the focus */              \
